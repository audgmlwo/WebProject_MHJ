...
//게시물 삭제 처리
@WebServlet("/files/BDEC")
public class FilesDeleteCtrl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
	    ...
	    // 게시물이 존재하지 않을 경우 처리
	    if (dto == null) {
	        resp.sendRedirect(req.getContextPath() + "/files/filesView.jsp");
	        return;
	    }
		...
		//삭제가 완료되면 목록으로 이동한다.
		JSFunction.alertLocation(resp, "삭제되었습니다.", "../files/BLPC");
	}
}
