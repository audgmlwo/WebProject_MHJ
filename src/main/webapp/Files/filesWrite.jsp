...
<body>
    ...
    <div class="form-container">
        <form action="../files/FilesWriteCtrl" method="post" enctype="multipart/form-data">
            ...
            <div class="button-container">
                <button type="button" class="btn-cancel" onclick="location.href='../Files/filesList.jsp'">취소</button>
                <button type="submit" class="btn-submit" onclick="location.href='../Files/filesList.jsp'">작성 완료</button>
            </div>
        </form>
    </div>
</body>
