			...
			<div class="container">
				<nav id="nav">
					<ul>
						...
						<li class="current_page_item"><a href="twocolumn2.jsp">Two Column #2</a></li>
						...
						<div id="content">
							<section>
								<div class="post">
									...
									<p><a href="#"><img src="${pageContext.request.contextPath}/images/pics03.jpg" alt=""></a></p>
				...
				<div class="row" id="footer-content">
					<div class="3u" id="box1">
						<section>
							...
							<p><a href="#"><img src="WebProject_MHJ/images/pics02.jpg" alt=""></a></p>
							<p>&nbsp;</p>
