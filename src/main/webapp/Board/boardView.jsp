                    ...
                    <section>
                        <div class="post">
                            ...
                            <div class="button-container">
                                    ...
                                    <button class="button" onclick="confirmDelete(${dto.board_id})&board_type=${dto.board_type}">삭제하기</button>
...
<script type="text/javascript">
		function confirmDelete(board_id, board_type) {
		    if (confirm('정말로 삭제하시겠습니까?')) {
		        location.href = `../board/delete.do?board_id=${board_id}&board_type=${board_type}`;
		    }
		}
</script>
