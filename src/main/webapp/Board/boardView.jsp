						...
						<section>
							<div class="post">
								...
								<div class="button-container">
									<c:if test="${not empty sessionScope.UserId}">
										<button class="button"
											onclick="location.href='../board/BEC?board_id=${dto.board_id}&board_type=${dto.board_type}'">수정하기</button>
										<button class="button"
											onclick="confirmDelete('${dto.board_id}&${dto.board_type}')">삭제하기</button>
									</c:if>
									<button class="button green"
										onclick="location.href='../board/BLPC'">목록으로</button>
								</div>
							</div>
						</section>
					</div>
	...
	<script type="text/javascript">
		function confirmDelete(board_id, board_type) {
			if (confirm('정말로 삭제하시겠습니까?')) {
				location.href = '../board/BDEC?board_id=' + board_id
